...
@section('content')
    <section class="flex items-center justify-center">
        <div class="max-w-3xl flex flex-col items-center border mt-8 mx-6 py-2 px-3">
            <div class="w-full flex flex-row gap-6 py-4">
                ...
                <div class="w-full flex flex-row items-center justify-end">
                    <div class="flex flex-col justify-end">
                        <p
                            class="text-xs text-center bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 cursor-pointer">
                            Editar Perfil</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col justify-start mb-4 ">
                <p class="text-sm">Desarrolladora frontend apasionada por crear experiencias web excepcionales. Me encanta
                    compartir
    ...
    <section class="flex items-center justify-center">
        <div class="w-full max-w-3xl grid grid-cols-2 md:grid-cols-4 gap-3 mb-8 text-sm text-center mx-6 mt-8">
            <x-blog.stats texto="Posts" numero="12" />
            <x-blog.stats texto="Comentarios" numero="45" />
            <x-blog.stats texto="Likes recibidos" numero="234" />
            <x-blog.stats texto="Vistas totales" numero="5,678" />
        </div>
    </section>

    <section class="flex items-center justify-center">
        <div class="w-full max-w-3xl flex flex-row items-center justify-center px-4 py-1 mx-6 border rounded-lg">
    ...
    <section class="flex items-center justify-center">
        <div class="w-full max-w-3xl flex flex-col justify-center items-center mt-8 mx-6">
